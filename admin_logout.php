...
<head>
    ...
    <title><?= $isConfirmed ? 'Admin Logged Out' : 'Confirm Admin Logout' ?> | ZEALHUB</title>
    <?php if ($isConfirmed): ?>
...
<body>
    ...
    <div class="logout-box">
        <?php if ($isConfirmed): ?>
            ...
            <p>You have signed out of the <strong>ZEALHUB Admin Control Panel</strong>.<br>Redirecting to admin login page...</p>
            ...
            <div class="btn-group">
                <a href="admin_login.php" class="btn btn-primary">
                    <i class="fa-solid fa-right-to-bracket"></i> Admin Login Again
                </a>
        ...
        <?php else: ?>
            ...
            <h1>Confirm Admin Logout</h1>
            <p>Are you sure you want to log out of your <strong>ZEALHUB Administrator Account</strong>?</p>

            <div class="btn-group">
                <a href="admin_dashboard.php" class="btn btn-cancel">
                    <i class="fa-solid fa-xmark"></i> Cancel
                </a>
                <a href="admin_logout.php?confirm=true" class="btn btn-danger">
